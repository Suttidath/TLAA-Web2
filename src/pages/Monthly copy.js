...
import FormA from "../pages/Components/FormA";
import FormB from "../pages/Components/FormB";
...
export default function Monthly() {
  ...
  const handleImport = (jsonData) => {
    // setDataRow(jsonData[0]);
    // console.log("datacom1", dataRow1);
    console.log("datacom2", dataRow2);
    console.log("datacom3", dataRow3);
  };
              ...
              <TableRow key={index}>
                ...
                <TableCell style={{ width: 120 }} align="left">
                  ...
                  >
                    ...
                    />
                    {/* <Link to="/monthly/edit" style={{ textDecoration: "none" }}>
                      <FiEdit style={{ color: "#4fc3f7", cursor: "pointer" }} />
                    </Link> */}
                    &nbsp;&nbsp;
                    <BsFillXCircleFill
        ...
        <Box sx={style}>
          ...
          <Box sx={{ mt: 9, display: "flex" }}>
            ...
            <Button variant="contained" size="middle" color="inherit">
              <Typography fontSize={14} onClick={handleClose}>
                Back
              </Typography>
            </Button>
          </Box>
            ...
            <TableContainer component={Paper}>
              ...
              >
                ...
                >
                  <TableRow>
                    <TableCell>
                      &nbsp;&nbsp; {dataRow2.รายงานสถิติธุรกิจประกันชีวิต}
                    </TableCell>
                    <TableCell>&nbsp;&nbsp;{dataRow2.__EMPTY_1}</TableCell>
                    <TableCell>&nbsp;&nbsp;{dataRow2.__EMPTY_2}</TableCell>
                    <TableCell>&nbsp;&nbsp;{dataRow2.__EMPTY_3}</TableCell>
                    <TableCell>&nbsp;&nbsp;{dataRow2.__EMPTY_4}</TableCell>
                    <TableCell>&nbsp;&nbsp;{dataRow2.__EMPTY_5}</TableCell>
                    <TableCell>&nbsp;&nbsp;{dataRow2.__EMPTY_6}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
